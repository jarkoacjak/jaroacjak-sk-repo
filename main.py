...
def main():
    ...
    # --- 2. ZOZNAM SLOVENSKÝCH RÁDIÍ (OPRAVENÉ LOGÁ) ---
    elif params.get('country') == 'sk':
        radia_sk = [
            {
                "nazov": "Rádio Slovensko", 
                "url": "https://icecast.stv.livebox.sk/slovensko_128.mp3", 
                "logo": "https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/R%C3%A1dio_Slovensko.svg/1200px-R%C3%A1dio_Slovensko.svg.png"
            },
            {
                "nazov": "Rádio Expres", 
            ...
            },
            {
                ...
                "logo": "https://www.radiomelody.sk/cover.png?f=raw"
            },
            {
                "nazov": "Rádio Beta", 
                "url": "http://109.71.67.102:8000/beta_live_high.mp3", 
                "logo": "https://myonlineradio.sk/public/uploads/radio_img/radio-beta/play_250_250.webp"
            },
            {
                "nazov": "Fun Rádio", 
                "url": "https://stream.funradio.sk:8000/fun128.mp3", 
                "logo": "https://yt3.googleusercontent.com/ytc/AIdro_niUH455B3J3TNWuMR1jez81UxI_mXNeMfNZ0RyU7nWWA=s900-c-k-c0x00ffffff-no-rj"
            },
            {
                "nazov": "Rádio Vlna", 
                "url": "https://stream.radiovlna.sk/vlna-128.mp3", 
                "logo": "https://play-lh.googleusercontent.com/1XTpQPfIg8cZLeASZoAEJlHivVgu5mOlclO8JqFn2hMoY2LlXHdsmkKjeWX6L_9t_Q"
            }
        ]
